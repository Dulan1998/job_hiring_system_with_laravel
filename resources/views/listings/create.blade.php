<x-layout>
  <x-card class="p-10 max-w-lg mx-auto mt-24">
    <header class="text-center">
      ...
      <p class="mb-4">Post a Post to find a employee</p>
    </header>
    ...
    <form method="POST" action="/listings" enctype="multipart/form-data">
      ...
      {{-- salary--------------------------------------------------------------- --}}
      <div class="mb-6">
        <label for="salary" class="inline-block text-lg mb-2">Job Salary  per month in Rs</label>
        <input type="text" class="border border-gray-200 rounded p-2 w-full" name="salary"
          placeholder="Example: 1000000" value="{{old('salary')}}" />
      ...
      <div class="mb-6">
        <label for="website" class="inline-block text-lg mb-2">
          Your Company Website or Facebook Page
        </label>
