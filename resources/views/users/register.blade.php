<x-layout>
  <div class="mx-4 flex justify-center items-center h-screen" style="width: 100%; height: 700px; background-image: url('images/employee.jpg'); background-size: cover; background-position: center;">
